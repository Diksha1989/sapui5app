		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Order",
									"targetURL": "#comorderorderapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comorderorderapp-display": {
								"semanticObject": "comorderorderapp",
								"action": "display",
								"description": "A SAPUI5 application.",
								"title": "Order",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.order.orderapp",
									"url": sap.ui.require.toUrl("com/order/orderapp")
								}
							}
						}
					}
